...
import { n as authConfigured, r as gateIdentityEnabled, t as auth } from "./server-BMf7BEVC.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/verify.server-C6xviJG0.js
/**
...
async function getSessionUser(bearerToken) {
	...
	if (!isFalconAdvisorEmail(email)) return null;
	return {
		id: session.user.id,
		email
	};
