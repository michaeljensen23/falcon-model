...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DQZtXN37.mjs");
...
var manifest = {
	"05ae0d40a3cb54bd75b323743f94c2544672af619503c93a786af9f430cfd1da": {
		functionName: "sendProposalEmail_createServerFn_handler",
		importer: () => import("./proposal-email-DtGY_qwA.mjs")
	},
	"1eded42adfab784c4924a34d0ff5c82dfe5e38615830b2b79d8f3db65b1b8c7b": {
		functionName: "getProposal_createServerFn_handler",
		importer: () => import("./proposals-Bt7dfFuI.mjs")
	},
	"4b57b759a4641d076ea49d8e5784b723fdf9c402c5947ece008fd3f220954b5a": {
		functionName: "listProposals_createServerFn_handler",
		importer: () => import("./proposals-Bt7dfFuI.mjs")
	},
	"7d631ed7f384f316ac6b037f45fcbb5f87aac5f29af854d251280e1adbf97ab1": {
	...
	"ac303419f3bd6f94ee837f95e91005a600278deed4876cb96a25aa0d69185951": {
		...
		importer: () => import("./readiness-CV4aV6ZA.mjs")
	},
	"cff06ee5ed935e1ddc117dca0135eb189c4cec30c2991c916650aae9e8f97c91": {
		functionName: "fetchAdvisorSession_createServerFn_handler",
		importer: () => import("../__root-CRQn2urM.mjs")
	},
	"f1fb99c63e98af54e7e2066ae009d14a0c0d91d6955c350f66559f6967e3c96f": {
		functionName: "deleteProposal_createServerFn_handler",
		importer: () => import("./proposals-Bt7dfFuI.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CvKedwBr.mjs").then((n) => n.t),
