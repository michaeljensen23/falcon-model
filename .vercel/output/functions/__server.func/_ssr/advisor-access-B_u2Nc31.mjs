//#region node_modules/.nitro/vite/services/ssr/assets/advisor-access-B_u2Nc31.js
/** Google Workspace domain allowed to use the advisor model. */
var ADVISOR_EMAIL_DOMAIN = "falconwp.com";
/** Broker provider id for Google — the only sign-in method this app offers. */
var GOOGLE_PROVIDER_ID = "grok-google";
...
*/
function isFalconAdvisorEmail(email) {
...
function advisorEmailHint() {
	return `@${ADVISOR_EMAIL_DOMAIN}`;
}
//#endregion
export { advisorEmailHint as n, isFalconAdvisorEmail as r, GOOGLE_PROVIDER_ID as t };
